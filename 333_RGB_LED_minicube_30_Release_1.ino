 ...
 * DISCLAIMER:  This is provided on an as-is basis
    ...
    Copyright (C) 2018 Ragnar Aronsen
    
    (Except the fix_fft stuff)
  ...
  The usual uneccesarily detailed devlog:
    ...
    2020.04.06 - Description edits for v. 0.30 release 1
...
SCHEMATICS DESCRIPTION
  ...
  There is a simple schematics at the github repo:
  https://github.com/rar0n/333-RGB-LED-MiniCube/blob/master/README.md
